...
func TestNodeAffinityPriority(t *testing.T) {
	...
	affinity1 := api.Affinity{
		...
		SoftNodeAffinity: []api.SoftNodeAffinityTerm{{Weight: 2, MatchExpressions: []api.NodeSelectorRequirement{
	...
	affinity2 := api.Affinity{
		...
		SoftNodeAffinity: []api.SoftNodeAffinityTerm{{Weight: 2, MatchExpressions: []api.NodeSelectorRequirement{
			...
			{Weight: 4, MatchExpressions: []api.NodeSelectorRequirement{{Key: "key", Operator: api.NodeSelectorOpIn, Values: []string{"value"}}}},
			{Weight: 5, MatchExpressions: []api.NodeSelectorRequirement{{Key: "key", Operator: api.NodeSelectorOpIn, Values: []string{"value"}},
				{Key: "foo", Operator: api.NodeSelectorOpIn, Values: []string{"bar"}},
				{Key: "az", Operator: api.NodeSelectorOpIn, Values: []string{"az1"}}}}}}
